...
screen.fill([255,255,255])
 ...
 #draw lines
pygame.draw.line(screen,(0,0,0),(200,600),(200,0))
pygame.draw.line(screen,(0,0,0),(400,600),(400,0))
pygame.draw.line(screen,(0,0,0),(600,200),(0,200))
pygame.draw.line(screen,(0,0,0),(600,400),(0,400))
...
def move(side, pos):
    ...
    pygame.draw.rect(screen,(side*100,0,side*100),(pos[0]*200,pos[1]*200,200,200))
    if side == 2:
        AIs.append(pos)
    if side == 1:
        PLAYERs.append(pos)
...
while going:
    ...
    for event in pygame.event.get():
        if event.type == pygame.MOUSEBUTTONDOWN:
            if board[int(mousepos[1]/200)][int(mousepos[0]/200)] == 0:
                move(1,[int(mousepos[0]/200),int(mousepos[1]/200)])
                pygame.display.flip()
                checkwin()
                moveAI()
                pygame.display.flip()
